...
export default function Contact() {
	...
	return (
		<main className="bg-[#1E1F27] pt-10 pb-20 px-4 lg:px-0">
			<article className="max-w-[1248px] mx-auto text-white">
				<header>
					<h1 className="leading-none uppercase text-[20px] sm:text-[30px] font-semibold">
						{t("contact-h1")}
					</h1>
				...
				<section className="mt-10">
					<iframe
						loading="lazy"
						className="max-w-[1248px] w-full h-[30vh] lg:h-[48vh] rounded-xl"
