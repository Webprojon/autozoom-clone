		...
		<main className="bg-about-img text-white border-b-2">
			<article className="py-10 space-y-8 w-[1248px] mx-auto tracking-wide">
				...
				<section className="text-[18px]">
					<h2 className="font-medium text-[26px] leading-8">{t("about-h2")}</h2>
					<p className="mt-4">{t("about-p1")}</p>
				</section>

				<section className="space-y-5 text-[18px]">
					<h2 className="font-medium text-[28px]">{t("about-h3")}</h2>
					<p>
				...
				<section className="space-y-5 text-[18px]">
					<h2 className="font-medium text-[28px]">{t("about-h4")}</h2>
					<p>{t("about-p6")}</p>
					<h2 className="font-medium text-[28px]">{t("about-h5")}</h2>
					<p>{t("about-p7")}</p>
				</section>
			</article>
		</main>
